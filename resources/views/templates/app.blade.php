...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <a class="navbar-brand" href="{{ route('home') }}">SCV</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav">
                ...
                <a class="nav-item nav-link" href="{{ route('show-products') }}">Listagem de Produtos Cadastrados</a>
    ...
    <div class="container">
      <div class="row">
       ...
       <div class="col-lg-3 gauche">
          <section>
            <span class="text-light">Ricardo Tristão Porfirio <br />
            (32) 98449-0985</span>
          </section>
       </div>
       <div class="col-lg-5 corps">
        <section>
          ...
          rtristaoporfirio@gmail.com</span>
        </section>
       </div>
       <div class="col-lg-2">
       </div>
